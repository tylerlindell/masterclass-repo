...
class Web extends Config
{
	public function define(Container $di)
	{
		 ...
		 * Aura\Web\Client
		 */
		$di->params['Aura\Web\Client'] = array(
			'server' => $_SERVER,
		);
		 ...
		 * Aura\Web\Content
		 */
		$di->params['Aura\Web\Content']['server'] = $_SERVER;
		 ...
		 */
		$di->params['Aura\Web\Request\Headers']['server'] = $_SERVER;
		 ...
		 */
		$di->params['Aura\Web\Request\Url']['server'] = $_SERVER;
	...
	=============================================*/
		 ...
		 */
		$di->params['Aura\Web\Response\Headers']['server'] = $_SERVER;

		/**
		 * Aura\Web\Request\Content
		 */
		$di->params['Aura\Web\Request\Content']['headers'] = $di->lazyGet('aura/web:response_headers');

		/**
		 * Aura\Web\Request\Cache
		 */
		$di->params['Aura\Web\Request\Cache']['headers'] = $di->lazyGet('aura/web:response_headers');
